export default function useButtonStyle (props:any) {
    ...
    styles["--nibu-button-text-color"] = props.text ? props.bg : props.textColor;
    styles["--nibu-button-text-hover-color"] =  props.text ? props.disabled ? `color-mix(in srgb, ${props.bg} 70%, white)` :`color-mix(in srgb, ${props.bg} 80%, white)` : "none";
    styles["--nibu-button-text-active-color"] =  props.text  ?props.disabled ? `color-mix(in srgb, ${props.bg} 70%, white)` : `color-mix(in srgb, ${props.bg} 80%, black)` : "none";
